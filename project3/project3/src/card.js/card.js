export default function Card({image,Designation,name}){
    ...
    return (
        <div style={{backgroundColor:"black", color:"whitesmoke", border:"3px solid white", margin:"auto", width:"50%" , marginTop:"20px",borderRadius:"40px"}}>
          <img src={image} width="200px" style={{borderRadius:"50%",padding:"25px"}}/>
          <p>{Designation}</p>
          <h3>{name}</h3>
